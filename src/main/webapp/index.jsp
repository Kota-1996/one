...
<head>
    ...
    <title>KOTA — Convenience Store</title>
    ...
    <style>
        ...
        :root {
            ...
            --shadow-hover: 0 12px 48px rgba(43, 33, 24, 0.12);
        ...
        * {
        ...
        .hero {
            ...
            overflow: hidden;
            margin: 20px 24px 0;
            background: linear-gradient(135deg, #2b2118 0%, #4a3627 100%);
        }
        .hero::before {
            content: '';
            position: absolute;
